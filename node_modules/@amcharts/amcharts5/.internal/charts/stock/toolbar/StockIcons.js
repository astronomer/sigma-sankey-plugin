 ...
 * @todo review
 */
var StockIcons = /** @class */ (function () {
    function StockIcons() {
    }
    Object.defineProperty(StockIcons, "getIcon", {
        enumerable: false,
        configurable: true,
        writable: true,
        value: function (id) {
            var icons = StockIcons.icons;
            var icon = icons[id] || icons["Default"];
            return StockIcons._getSVG(icon);
        }
    });
    Object.defineProperty(StockIcons, "_getSVG", {
        enumerable: false,
        configurable: true,
        writable: true,
        value: function (icon) {
...
export { StockIcons };
//# sourceMappingURL=StockIcons.js.map