 ...
 * @ignore
 */
var StockChartDefaultTheme = /** @class */ (function (_super) {
    __extends(StockChartDefaultTheme, _super);
    function StockChartDefaultTheme() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    Object.defineProperty(StockChartDefaultTheme.prototype, "setupDefaultRules", {
        enumerable: false,
        configurable: true,
        writable: true,
        value: function () {
            ...
            {
                var rule = r("RoundedRectangle", ["legend", "itemcontainer", "background", "stocklegend"]);
                rule.setAll({
                    fillOpacity: 1,
                    cornerRadiusBL: 4,
                    cornerRadiusBR: 4,
            ...
            {
                var rule = r("Rectangle", ["panelresizer"]);
                rule.setAll({
                    width: p100,
                    height: 15,
                    centerY: p100,
            ...
            {
                var rule = r("Button", ["control", "item", "settings"]);
                rule.setAll({
                    forceHidden: false
                });
            }
            {
                var rule = r("RoundedRectangle", ["background", "control", "button"]);
                rule.setAll({
                    fillOpacity: 0,
                    strokeOpacity: 0
                });
            ...
            {
                var rule = r("Graphics", ["control", "button", "icon"]).states.create("hover", {
                    fillOpacity: 0.5
                });
                setColor(rule, "fill", ic, "secondaryButtonHover");
            }
            {
                var rule = r("Graphics", ["control", "button", "icon"]).states.create("down", {
                    fillOpacity: 0.5
                });
             ...
             */
            {
                var rule = r("Graphics", ["close", "button", "icon"]);
                rule.setAll({
                    strokeOpacity: 0.7,
                    strokeWidth: 0.5,
             ...
             */
            {
                var rule = r("Graphics", ["settings", "button", "icon"]);
                rule.setAll({
                    strokeOpacity: 0.7,
                    strokeWidth: 0.5,
                    draw: function (display) {
                        ...
                        var ir = 8;
                        var spikes = 9;
                        var angleStep = 360 / spikes * $math.RADIANS / 2;
                        display.moveTo(r, 0);
                        var angle = 0;
                        var dAngle = 5 * $math.RADIANS;
             ...
             */
            {
                var rule = r("Graphics", ["up", "button", "icon"]);
                rule.setAll({
                    strokeOpacity: 0.7,
                    strokeWidth: 0.5,
                    draw: function (display) {
             ...
             */
            {
                var rule = r("Graphics", ["expand", "button", "icon"]);
                rule.setAll({
                    strokeOpacity: 0.7,
                    strokeWidth: 0.5,
                    draw: function (display) {
             ...
             */
            {
                var rule = r("Graphics", ["down", "button", "icon"]);
                rule.setAll({
                    strokeOpacity: 0.7,
                    strokeWidth: 0.5,
                    draw: function (display) {
            ...
            {
                var rule = r("Container", ["drawing", "grip"]);
                rule.states.create("hover", {});
            }
            {
                var rule = r("Circle", ["drawing", "grip"]);
                rule.setAll({
                    strokeOpacity: 0.7,
                    strokeWidth: 1,
                    radius: 5
            ...
            {
                var rule = r("Circle", ["drawing", "grip", "outline"]);
                rule.setAll({
                    strokeOpacity: 0,
                    fillOpacity: 0,
                    strokeWidth: 5,
            ...
            {
                var rule = r("Graphics", ["series", "fill", "drawing"]);
                rule.setAll({
                    fillOpacity: 0.2,
                    visible: true,
                    draggable: true
            ...
            {
                var rule = r("Line", ["drawing", "horizontal"]);
                rule.setAll({
                    strokeWidth: 2,
                    strokeDasharray: 0
                });
                var stateRule = rule.states.create("hover", {});
                setColor(stateRule, "stroke", ic, "negative");
            }
            {
                var rule = r("Line", ["drawing", "vertical"]);
                rule.setAll({
                    strokeWidth: 2,
                    strokeDasharray: 0
                });
            ...
            {
                var rule = r("Graphics", ["series", "fill", "drawing", "doodle"]);
                rule.setAll({
                    fillOpacity: 0
                });
            ...
            {
                var rule = r("Graphics", ["line", "series", "stroke", "drawing"]);
                rule.setAll({
                    strokeWidth: 2,
                    draggable: true
                });
            ...
            {
                var rule = r("Graphics", ["drawing", "icon"]);
                rule.setAll({
                    centerX: p50,
                    centerY: p100,
                    strokeOpacity: 1,
                ...
                var hoverRule = rule.states.create("hover", {});
            ...
            // resizer
            {
                var rule = r("RoundedRectangle", ["drawing", "grip"]);
                rule.setAll({
                    strokeOpacity: 0.7,
                    strokeWidth: 1,
                    fillOpacity: 1,
            ...
            {
                var rule = r("RoundedRectangle", ["drawing", "grip", "outline"]);
                rule.setAll({
                    strokeOpacity: 0,
                    fillOpacity: 0,
                    width: 20,
            ...
            {
                var rule = r("RoundedRectangle", ["series", "column", "volume"]);
                rule.setAll({
                    fillOpacity: 0.5,
                    stroke: ic.get("background"),
                    strokeOpacity: 0.2
                });
                rule.adapters.add("fill", function (fill, target) {
    ...
    return StockChartDefaultTheme;
}(Theme));
export { StockChartDefaultTheme };
//# sourceMappingURL=StockChartDefaultTheme.js.map