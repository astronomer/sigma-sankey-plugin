...
export interface PluginInstance<T> {
    ...
    elements: {
        ...
        subscribeToElementColumns(id: string, callback: (cols: WbElementColumns) => void): Unsubscriber;
        subscribeToElementData(id: string, callback: (data: WbElementData) => void): Unsubscriber;
    };
    destroy(): void;
}
